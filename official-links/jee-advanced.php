...
<body style="text-align: center;" class="headingimg" oncontextmenu="return false;">
    ...
    <script>
      ...
      document.getElementById("navBtn_Adv").className += " active";
    </script>
    ...
    <div style="padding: 2%; background-image: url('../images/tg-bg.jpg');">
      ...
      <div style="isolation: isolate;">
          <script async src="https://telegram.org/js/telegram-widget.js?19" data-telegram-post="jeechallengerindex/11" data-width="100%" data-dark="1"></script>
      </div>  
    </div>
