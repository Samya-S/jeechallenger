...
<body style="text-align: center;" class="headingimg" oncontextmenu="return false;">
    ...
    <script>
      document.getElementById("navBtn_MorePlatforms").className += " active";
      document.getElementById("navBtn_Unacademy").className += " active";
    </script>
    ...
    <div style="padding: 2%;">
      ...
      <img src="../images/Unacademy-subscription.gif" alt="" srcset="" style="max-width: 100%; padding: 2%;"><br>
